        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BatteryPct = table.Column<double>(type: "REAL", nullable: false),
                    SignalStrength = table.Column<double>(type: "REAL", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TelemetryReadings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TelemetryReadings_Missions_MissionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TelemetryReadings_MissionId",
